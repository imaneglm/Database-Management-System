...
The backend logic is achieved through Java RMI. Java RMI enables communication between the client and server remotely.

# Technologies Used

Java – core programming, server, and interfaces.
SQLite – database management (product.db).
